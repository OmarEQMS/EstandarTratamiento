    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            for(var i = 0; i < response.length; i++){
                $("#estandares").append("<div class='card mt-3'><div class='btn card-body algoritmosBorde'><div class='row'><div data-id='" + response[i].idNodo + "' class='estandar col-10'><span>" + response[i].nombre + "</span></div><div class='col-2 col-sm-1'><i data-id='" + response[i].idEstandar + "' class='infoEstandar d-block pull-right fas fa-info-circle float-right icono-info' style='font-size:27px' data-placement='top'> </i></div></div></div></div>")
            }
